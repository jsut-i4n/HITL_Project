...
class TaskExcuteOneAgent(Agent):
    ...
    def output_keys(self) -> list[str]:
        ...
        return ['task_excute_one_agent_result']
    ...
    def parse_input(self, input_object: InputObject, agent_input: dict) -> dict:
        ...
        for item in x:
            for k, v in item.items():
                if k == '政治':
                    agent_input['input'] = v
        #agent_input['input'] = input_object.get_data('client_manager_result').get_data('framework')[0]
    ...
    def parse_result(self, planner_result: dict) -> dict:
        ...
        return {"task_excute_one_agent_result": planner_result}
